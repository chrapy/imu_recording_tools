...
class SensorDriftManager : AppCompatActivity() {
    ...
    lateinit var smAdapterDrift: SensorDriftManagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = smAdapterDrift
