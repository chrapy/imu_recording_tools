...
import com.pascaldornfeld.gsdble.manage_sensors.UpdateSensorManager;

import java.util.ArrayList;

public class SensorDriftManagerAdapter extends RecyclerView.Adapter<SensorDriftManagerAdapter.MyViewHolder> {
    ...
    SensorDriftManagerAdapter(Activity activity, Context context, ArrayList deviceMac, ArrayList deviceName, ArrayList deviceDrift){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.knownSensorLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, UpdateSensorDriftManager.class);
